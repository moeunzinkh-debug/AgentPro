...
export const ModelSelectionModal: React.FC<ModelSelectionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85">
      <div className="w-full max-w-lg rounded-2xl glass gradient-panel-modal border border-violet-400/40 p-6 shadow-[0_10px_40px_rgba(0,0,0,0.9)] space-y-5 animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto custom-scrollbar">
        {/* Header */}
